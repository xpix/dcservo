  ...
  public:
    ...
    quadCounter(int timer_number) {
      ...
      switch(_timer_number) {
        case QUAD_TIMER_1:  timer[1]->attachInterrupt(0, func1);
                            break;
        case QUAD_TIMER_3:  timer[3]->attachInterrupt(0, func3);
                            break;
        case QUAD_TIMER_4:  timer[4]->attachInterrupt(0, func4);
                            break;
      }
    ...
    void placeCount(long count) {
      timer[_timer_number]->setCount(count);
    }
